                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-red-sunglo bold uppercase">ADD EXPENSE</span>
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open('admin/account/add_out_transaction/', $attributes); ?>
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div id="roomset" class="col-md-8">
                                                                <select class="form-control" name="income[0][Category]">
                                                                    ...
                                                                    <option selected="selected" value="13">Expense</option>
                                                                    <option value="14">Cost</option>
                                                                    <option value="15">Fee</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
