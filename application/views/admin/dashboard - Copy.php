                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div class="portlet-body">
                                        <a href="http://londonroomsuk.com/index.php/admin/property" class="icon-btn">
                                            <i class="track-icon icon-property normal"></i>
                                            <span>Properties</span>
                                        </a>
                                        <a href="http://londonroomsuk.com/index.php/admin/management" class="icon-btn">
                                            <i class="track-icon icon-management normal"></i>
                                            <span>Management</span>
                                        </a>
                                        <a href="http://londonroomsuk.com/index.php/admin/tenant/add/null/null" class="icon-btn">
                                            <i class="track-icon icon-tenant normal"></i>
                                            <span>New Tenant</span>
                                        </a>
                                        <a href="http://londonroomsuk.com/index.php/admin/room" class="icon-btn">
                                            <i class="track-icon icon-room normal"></i>
                                            <span>Rooms</span>
                                        </a>
                                        <a href="http://londonroomsuk.com/index.php/admin/tenant/offer" class="icon-btn">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-8 col-md-8">
                                            <div>
                                                ...
                                                <span class="ng-binding"><b class="ng-binding">0</b> vacant</span>
                                            </div>
                                            <br>
                                            <div>
                                                <span class="badge badge-danger">  </span>
                                                <span class="ng-binding"><b class="ng-binding">0</b> occupied</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
