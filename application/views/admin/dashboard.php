...
<script type="text/javascript">
    ...
    var ar = <?php echo json_encode($get_count_tenant_country) ?>;
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject font-green bold uppercase">Quick buttons</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="portlet-body">
                                        <a href="<?php echo base_url()?>index.php/admin/property" class="icon-btn">
                                            <i class="track-icon icon-property normal"></i>
                                            <span>Properties</span>
                                        </a>
                                        <a href="<?php echo base_url()?>/index.php/admin/management" class="icon-btn">
                                            <i class="track-icon icon-management normal"></i>
                                            <span>Management</span>
                                        </a>
                                        <a href="<?php echo base_url()?>/index.php/admin/tenant/add/null/null" class="icon-btn">
                                            <i class="track-icon icon-tenant normal"></i>
                                            <span>New Tenant</span>
                                        </a>
                                        <a href="<?php echo base_url()?>/index.php/admin/room" class="icon-btn">
                                            <i class="track-icon icon-room normal"></i>
                                            <span>Rooms</span>
                                        </a>
                                        <a href="<?php echo base_url()?>/index.php/admin/tenant/offer" class="icon-btn">
                                            <i class="track-icon icon-offer normal"></i>
                                            <span>Pending</span>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-red-sunglo bold uppercase">Properties</span>
                                    </div>
                                </div>
                                <div class="portlet-body" style="min-height: 185px">
                                    <br>
                                    <br>
                                    <?php /*foreach($property_stat as  $p_stat){
                                        $percent=$p_stat['percent'];
                                    }*/?>
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-4 col-md-4 no-padding ng-scope">
                                            <?php if ($property_stat['percent']==0) { ?>
                                                <i class="track-icon icon-unit medium"></i>
                                                <?php
                                            } else
                                            {
                                            ?>
                                            <div class="easy-pie-chart">
                                                <div class="number bounce" data-percent="<?php echo $property_stat['percent'];?>">
                                                    <span><?php echo $property_stat['count_property'].' ';?></span>Total</div>
                                            </div>
                                            <?php }?>
                                        </div>
                                        <div class="col-xs-12 col-sm-8 col-md-8">
                                            <div>
                                                ...
                                                <span class="ng-binding"><b class="ng-binding"><?php echo $property_stat['count_vacant'];?></b> vacant</span>
                                            </div>
                                            <br>
                                            <div>
                                                <span class="badge badge-danger">  </span>
                                                <span class="ng-binding"><b class="ng-binding"><?php echo $property_stat['count_occupied'];?></b> occupied</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-4">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="icon-share font-red-sunglo hide"></i>
                                        <span class="caption-subject font-red-sunglo bold uppercase">LEASES</span>
                                    </div>
                                    <div class="actions">
                                       <span class="font-green-sunglo bold "> EXPIRES In 30 Days</span>
                                    </div>
                                </div>
                                <div class="portlet-body" style="min-height: 185px">
                                    <div class="text-center">

                                            <span class="font-green-jungle font-lg bold uppercase leases_font">1</span>
                                            <span class="m-l-10 text ng-binding">of 2</span>
                                        <div class="font-dark font-md sbold">ending in 30 days</div>
                                    </div>
                                </div>
                                <div class="task-footer">
                                    <div class="btn-arrow-link pull-right">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat blue">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="<?php echo $get_count_tenant?>">0</span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat red">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="<?php echo $get_count_rooms?>">0</span></div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat green">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="counterup" data-value="<?php echo $get_count_occupied_rooms?>">0</span>
                                    </div>
                                    <div class="desc"> Occupied Rooms </div>
                                </div>
                                <a class="more" href="javascript:;"> View more
                                    <i class="m-icon-swapright m-icon-white"></i>
                                </a>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat purple">
                                ...
                                <div class="details">
                                    <div class="number"> +
                                        <span data-counter="counterup" data-value="<?php echo $get_count_offer; ?>">0</span></div>
                                    <div class="desc">Pending Offer</div>
                                </div>
                                <a class="more" href="javascript:;"> View more
                                    <i class="m-icon-swapright m-icon-white"></i>
                                </a>
