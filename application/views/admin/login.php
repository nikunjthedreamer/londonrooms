...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="">
                <img src="<?php echo base_url();?>assets/pages/img/rent.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
...
echo form_open('admin/create_member', $attributes); ?>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="email_address" /> </div>
                <div class="form-group">
