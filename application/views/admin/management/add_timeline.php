 <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Add Timeline
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase"> Property Timeline</span>
                                    </div>
                                    <div class="actions">
                                        <div class="btn-group">
...
echo form_open('admin/management/add_timeline/'.$this->uri->segment(4).'', $attributes); ?>
                                        <div class="form-body">
