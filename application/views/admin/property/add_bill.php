...
echo form_open('admin/property/add_bill/'.$this->uri->segment(4).'', $attributes); ?>
		<div class="form-body">
		...
		<label class="col-md-3 control-label">Account Holder</label>
			<div class="col-md-4">
			<input type="text"  name="acc_holder" class="form-control" placeholder="Enter Account Holder" />
			</div>
		</div>
		<div class="form-group">
		<label class="col-md-3 control-label">Payment Method</label>
			<div class="col-md-4">
				<input type="text"  name="pay_method" class="form-control" placeholder="Enter Payment Method" />
			</div>
		</div>
