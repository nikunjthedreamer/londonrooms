 <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h3 class="page-title"> Add New Tenancy
		...
		<span class="caption-subject font-red-sunglo bold uppercase">Add New Tenancy</span>
...
echo form_open('admin/property/add_tenancy/'.$this->uri->segment(4).'', $attributes); ?>
		<div class="form-body">
		...
		<?php foreach($rooms as $room){   ?>
			<option value="<?php echo $room['id']; ?>"><?php echo $room['room_name']; ?> @ <?php echo $property['0']['address']; ?></option>
		<?php  }   ?>
		</select>
		...
		<div class="col-md-4">
		<input type="text" value="" name="start_date" class="form-control date-picker" placeholder="Enter Start date">
		<span class="help-block">  </span>
		</div>
		</div>
		<div class="form-group">
			...
			<input type="number" value="" name="initial_rent" class="form-control" >
			</div>
			</div>
		...
		<h3 class="form-section">Optional Details:</h3>
			<div class="form-group">
				...
				<div class="col-md-4">
				<input type="text" value="" name="finish_date" class="form-control date-picker" placeholder="Enter Finish date">
			...
			<div class="form-group">
				...
				<input  type="checkbox"   name="furnished_letting"/>
				</div>				
            </div>
			<div class="form-group">
                <label class="col-md-3 control-label"></label>
				...
				<input  type="checkbox"   name="assured_tenancy"/>
				</div>				
            </div>
		    ...
		    <div class="form-group">
				...
				<div class="col-md-4">
				<input type="number" value="" name="ast_duration" class="form-control" placeholder="Enter AST Duration">
				<span class="help-block">  </span>
				</div>
			</div>
		<div class="form-group">
		...
		<div class="col-md-4">
			...
			<input type="number" value="" name="deposit" class="form-control" >
			</div>
			</div>
		</div>		
