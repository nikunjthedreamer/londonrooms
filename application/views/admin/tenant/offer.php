                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Pending Offer List</span>
                                    </div>
                                    <div class="actions">
...
if($status=='pending') {
						...
						<a href="<?php  echo base_url();   ?>index.php/admin/tenant/detail/<?php echo $tenant['id']; ?>" id="register-btn" class="btn btn-info " >View </a><?php } if($this->session->userdata('role')=="Admin" ){  ?><a href="<?php  echo base_url();   ?>index.php/admin/tenant/tenant_delete/<?php echo $tenant['id']; ?>" id="register-btn" class="btn btn-danger " onclick="return confirm('Are you sure you want to delete this item?');" >Delete </a><?php }  ?></td>
						</tr>
<?php }  }   ?>
