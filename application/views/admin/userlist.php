                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
											...
											<?php  //echo base_url();   ?>
                                                <div class="btn-group">
												 <a href="<?php  echo base_url();   ?>index.php/admin/signup" id="register-btn" class="btn sbold green">Add New <i class="fa fa-plus"></i></a>
                                           ...
                                           <tr class="odd gradeX">
                                               ...
                                               <td> <?php echo $user['role'] ;   ?> </td>
												...
												<?php if($user['status']=='1'){    ?>
												 ...
												 <td>  <a href="<?php  echo base_url();   ?>index.php/admin/user/edit/<?php echo $user['id']; ?>" id="register-btn" class="btn btn-info">Edit </a>   <a href="<?php  echo base_url();   ?>index.php/admin/user/user_delete/<?php echo $user['id']; ?>" id="register-btn" class="btn btn-danger ">Delete </a> </td>
                                            </tr>
										<?php } } ?>
