...
<html lang="en">
 ...
 <!-- BEGIN HEAD -->
    ...
    <head>
        ...
        <link href="<?php echo base_url();?>assets/apps/css/custom_n.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-closed">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="">
                        <img src="<?php echo base_url();?>assets/pages/img/rent_small.png" alt="logo" class="logo-default" /> </a>
                ...
                <div class="top-menu">
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" class="img-circle" src="<?php echo base_url();?>uploads/<?php echo $this->data['userdata']['0']['user_pic'];     ?>" />
                                <span class="username username-hide-on-mobile"> <?php echo ucfirst ($this->data['userdata']['0']['user_name']);     ?> </span>
